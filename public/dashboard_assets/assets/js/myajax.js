        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (i = 0; i < x.length; i++) {
                    output += "<tr><td>" + x[i].id + "</td><td>" + x[i].name + "</td><td>" + x[i].cell + "</td><td>" + x[i].email + "</td><td>" + x[i].gender + "</td><td>" + x[i].dob + "</td><td>" + x[i].address + "</td><td><button style='display: none;''  class='btn btn-warning' id='btnedit' data-sid=" + x[i].id + ">Udpate</button><button  class='btn btn-danger' style='display: none;'' id='btndel' data-sid=" + x[i].id + ">Delete</button></td></tr>"
                    //hide and show edit and delete button code
                    // $(document).ready(function () {
