      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Layouts -->
            <li class="menu-item @yield('profile_active')">
                <a href="{{ route('user.profile') }}"  class="menu-link ">
                  <i class="menu-icon tf-icons bx bx-collection"></i>
                  <div data-i18n="Basic">Profile</div>
                </a>
            </li>
            <li class="menu-item @yield('direct_active')">
                <a href="cards-basic.html" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-collection"></i>
                  <div data-i18n="Basic">Direct Group</div>
                </a>
            </li>
            <li class="menu-item @yield('level_active')">
                <a href="cards-basic.html" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-collection"></i>
                  <div data-i18n="Basic">Level Group</div>
                </a>
            </li>
            <li class="menu-item @yield('activation_active')">
                <a href="cards-basic.html" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-collection"></i>
                  <div data-i18n="Basic">Activation</div>
                </a>
            </li>
            <li class="menu-item @yield('myincome_active')">
              <a href="cards-basic.html" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">My Income</div>
              </a>
            </li>
            <li class="menu-item @yield('Withdrawl_active')">
              <a href="cards-basic.html" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">Withdrawl</div>
              </a>
            </li>
            <li class="menu-item">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                        <div class="avatar avatar-online">
                            <img src="{{ asset('') }}dashboard_assets/assets/img/avatars/1.png" alt
                    ...
                    <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                        <div class="mb-2 mb-md-0">
                            ...
                            <a href="#" target="_blank"
                                class="footer-link fw-bolder">Umer</a>
                        </div>
                        <div>
